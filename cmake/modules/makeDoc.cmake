...
configure_file("${CMAKE_SOURCE_DIR}/.doxygen/Doxyfile" ${DOXYFILE_OUT} @ONLY)

add_custom_target("${PROJECT_NAME}_doc_html" ALL
...
if(BUILD_DOC_PDF)
    if(WIN32)
        ...
        add_custom_command(TARGET "${PROJECT_NAME}_doc_latex" POST_BUILD
                WORKING_DIRECTORY "${BUILD_OUT}/latex"
                COMMAND ${MAKE_EXECUTABLE}
                COMMAND ${CMAKE_COMMAND} -E copy
                "refman.pdf"
                "${BUILD_OUT}/${PROJECT_NAME}.pdf"
                BYPRODUCTS "${BUILD_OUT}/${PROJECT_NAME}.pdf"
